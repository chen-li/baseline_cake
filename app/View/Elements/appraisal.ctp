...
<div class="clear"></div>
<div class="input">
	<label>Additional Features <span class="icon question"></span><span class="tooltip">include any additional items that may be relevant to the value of your property eg. city views, security, ceiling fans etc</span></label>
