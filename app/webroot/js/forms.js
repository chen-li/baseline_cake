$(document).ready(function(){
	...
	if(typeof(webkit_resize) == 'undefined') {
		if($.browser.safari) {
...
function resize_parent(height, duration) {
	parent.$('#fancybox-content').animate({height: height}, duration);
	parent.$('#fancybox-wrap').animate({height: height+20}, duration);
}
